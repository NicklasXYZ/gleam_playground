...
export enum RuntimeType {
    GleamPlayground = 'GLEAM_PLAYGROUND',
    WebAssembly = 'WASM'
}
...
export default {
    ...
    apiKey: getVariableValue('API_KEY', ''),
    serverUrl: getVariableValue('SERVER_URL', ''),
    apiShare: getVariableValue('API_SHARE', ''),
    apiRun: getVariableValue('API_RUN', ''),
    githubUrl: getVariableValue('GITHUB_URL', 'https://github.com/nicklasxyz/gleam_playground'),
    issueUrl: getVariableValue('ISSUE_URL', 'https://github.com/nicklasxyz/gleam_playground/issues/new'),
    ...
    get runtimeType(): RuntimeType {
        ...
        return this.getValue<RuntimeType>(RUNTIME_TYPE_KEY, RuntimeType.GleamPlayground);
    },
