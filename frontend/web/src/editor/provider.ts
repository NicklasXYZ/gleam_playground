...
class GleamCompletionItemProvider implements monaco.languages.CompletionItemProvider {
...
export const registerGleamLanguageProvider = (client: IAPIClient) => {
    if (alreadyRegistered) {
        console.warn('Gleam language provider was already registered');
        return;
    }

    alreadyRegistered = true;
    return monaco.languages.registerCompletionItemProvider('gleam', new GleamCompletionItemProvider(client));
};
