...
const COMPILER_OPTIONS: IDropdownOption[] = [
    { key: RuntimeType.GleamPlayground, text: 'Gleam Playground' },
    {
                    ...
                    <Pivot aria-label='Settings'>
                        ...
                        <PivotItem headerText='Build' style={{paddingBottom: '64px'}}>
                            <SettingsProperty
                                key='runtime'
                                title='Runtime'
                                description='This option lets you choose where your Gleam code should be executed.'
                                control={<Dropdown
                                ...
                                control={<Checkbox
                                    ...
                                    onChange={(_, val) => {
                                        this.changes.args = {
                                            ...
                                            runtime: this.props.settings?.runtime ?? RuntimeType.GleamPlayground,
                                        };
                                    }}
                                />}
                            />
